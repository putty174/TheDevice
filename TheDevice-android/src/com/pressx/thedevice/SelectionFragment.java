...
public class SelectionFragment extends Fragment {
    ...
    FacebookSelectionListener mCallback;
    public interface FacebookSelectionListener {
    	public List<GraphUser> friendListReturn(List<GraphUser> selectedUser);
    	public GraphPlace placeReturn(GraphPlace selectedPlace);
    }
    ...
    public void onAttach(Activity activity) {
    	...
    	try {
    		mCallback = (FacebookSelectionListener) activity;
    	} catch (ClassCastException e) {
    		throw new ClassCastException(activity.toString() + "must implement FacebookSelectionListener interface");
    	}
    }
    ...
    private class EatListElement extends BaseListElement {
        ...
        public EatListElement(int requestCode) {
            super(getActivity().getResources().getDrawable(R.drawable.action_eating),
                    getActivity().getResources().getString(R.string.action_hitting),
                    getActivity().getResources().getString(R.string.action_hitting_default),
                    requestCode);
            foodChoices = getActivity().getResources().getStringArray(R.array.enemies);
            foodUrls = getActivity().getResources().getStringArray(R.array.enemy_urls);
        }
        ...
        private void getCustomFood() {
            String title = getActivity().getResources().getString(R.string.enter_enemy);
